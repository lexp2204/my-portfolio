...
export default function Hero(){
    return(
        <div id="home" style={{ backgroundColor: "#0C0C16" }} className="font-['Ubuntu_Sans_Mono'] px-5 py-4 flex flex-row gap-10 justify-center items-center">
           <div id="name-socials-container" className="flex flex-col gap-5 w-1/2 pt-15 pl-25">
                <div id="name-title" className="w-auto">
                    <h2 className="text-white text-2xl">Hi, I'm Alexis</h2>
                    <TypeAnimation sequence={["Software Developer", 2000, "Fullstack Engineer", 2000, "Tech Enthusiast", 2000]} wrapper="h1" cursor={true} repeat={Infinity} className="text-[#9013fe] text-5xl font-semibold pt-2.5"/>
                </div>
           ...
           <div id="animation" className="pl-0 pt-6 w-4xl h-4xl">
                <DotLottieReact 
