...
export default function About() {
    return (
        <div
            ...
            className="font-['Ubuntu_Sans_Mono'] py-12 px-4 sm:px-6 md:px-10 lg:px-20"
        >
            <h2 className="text-3xl text-white pb-12 text-center md:text-left">
                About Me
            </h2>

            <div className="flex justify-center">
                <div className="backdrop-blur-md bg-gray-200/10 rounded-xl shadow-2xl p-6 sm:p-8 md:p-10 w-full max-w-4xl text-white transition-all duration-300 hover:shadow-[#9013fe]/40 hover:scale-[1.02]">
                    <p className="text-base sm:text-lg leading-relaxed text-gray-200 pb-4">
